              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    borderRadius: 6,
                    border: isActive ? "1.5px solid #37352f" : "1px solid rgba(55,53,47,0.12)",
                    background: isActive ? "rgba(55,53,47,0.04)" : "#fff",
                    color: "#37352f",
                    cursor: "pointer",
                    boxShadow: isActive ? "0 0 10px rgba(55, 53, 47, 0.25)" : "none",
